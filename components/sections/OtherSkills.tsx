      ...
      <div className="max-w-7xl mx-auto">
          ...
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              <div className="glass rounded-2xl p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-indigo-300 dark:text-indigo-300 light:text-indigo-600">
                  {category.title}
                </h3>
                  ...
                  {category.skills.map((skill, skillIndex) => (
                    <div key={skill.name}>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-gray-300 dark:text-gray-300 light:text-gray-700 font-medium">{skill.name}</span>
                        <span className="text-gray-500 dark:text-gray-500 light:text-gray-600 text-sm">{skill.level}%</span>
                      </div>
        ...
        <RevealOnScroll delay={0.6} direction="up">
          <div className="mt-12 sm:mt-16 glass rounded-2xl p-6 sm:p-8 md:p-12 text-center">
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-indigo-300 dark:text-indigo-300 light:text-indigo-600">
              Always Learning, Always Creating
            </h3>
            <p className="text-gray-400 dark:text-gray-400 light:text-gray-600 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed px-4">

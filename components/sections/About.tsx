        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <RevealOnScroll delay={0.4} direction="left">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-base sm:text-lg text-gray-300 dark:text-gray-300 light:text-gray-700 leading-relaxed">
          ...
          <RevealOnScroll delay={0.5} direction="right">
            <div className="glass rounded-2xl p-6 sm:p-8 space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-600">My Philosophy</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-600">My Process</h3>
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-600">My Commitment</h3>
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-600">

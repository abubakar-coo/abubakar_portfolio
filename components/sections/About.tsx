...
export default function About() {
  return (
    <section id="about" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <RevealOnScroll delay={0.2} direction="left">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-base sm:text-lg text-gray-300 dark:text-gray-300 light:text-gray-900 light:font-semibold leading-relaxed">
          ...
          <RevealOnScroll delay={0.25} direction="right">
            <div className="glass rounded-2xl p-6 sm:p-8 space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-800 light:font-bold">My Philosophy</h3>
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-800 light:font-medium">
                  Design is not just about how it looks—it's about how it works, how it feels,
                  and how it impacts the user experience.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-800 light:font-bold">My Process</h3>
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-800 light:font-medium">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-indigo-300 dark:text-indigo-300 light:text-indigo-800 light:font-bold">My Commitment</h3>
                <p className="text-gray-400 dark:text-gray-400 light:text-gray-800 light:font-medium">
